...
import dataexpo.mapreduce.MultiTypeMapper;
import dataexpo.mapreduce.MultiTypeReducer;


@WebServlet("/MonMultiServlet2")	//web.xml의 servlet 태그 대체
